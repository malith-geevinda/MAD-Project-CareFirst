...
class ViewCustomerProfileActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.example.firebasekotlin.R.layout.activity_view_customer_profile)
...
// )
            ...
            userRef.addValueEventListener(object : ValueEventListener{
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    openUpdateDialog(customer?.uid.toString(), customer?.cusName.toString(), customer?.cusEmail.toString(), customer?.cusPhone.toString())
                }
...
//set updated data to textviews
            ...
            val intent = Intent(this, ViewCustomerProfileActivity::class.java) //change activity
            startActivity(intent)
        }
    }
    ...
    private fun updateProfileData(
        ...
        val dbRef = FirebaseDatabase.getInstance().getReference("Customers").child(userId)
